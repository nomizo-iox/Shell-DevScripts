...
export ZSH="/Users/computername/.oh-my-zsh"
export DEFAULT_USER='computername'
TERM=xterm-256color
...
POWERLEVEL9K_CUSTOM_BATTERY_STATUS_BACKGROUND="055"
POWERLEVEL9K_CUSTOM_INTERNET_SIGNAL_BACKGROUND="055"
